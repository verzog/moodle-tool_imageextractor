...
$string['replacemode_help'] = 'Single uses one uploaded image for every matched file (for example, a new brand logo). ZIP uses one or more uploaded archives of images, matching each target to the archive entry with the same filename (for example, watermarked versions of existing images). Metadata only does not change any image content - it just records a new author and/or licence on every matched file.';
