...
$string['altwarning'] = 'This updates the description (alt text) of the matching images in the course content that embeds them, across the whole site. Image content is not changed. The previous description is recorded against each file but is not restored automatically.';
...
$string['confirmaltfinal'] = 'Update the description (alt text) of {$a} images in the course content now? The image content is not changed, but the previous descriptions are overwritten and are not restored automatically.';
